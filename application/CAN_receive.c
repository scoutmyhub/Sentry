...
void HAL_CAN_RxFifo0MsgPendingCallback(CAN_HandleTypeDef *hcan)
{
  ...
  else
  {
    ...
    case CAN_TRIGGER_MOTOR_ID:
      ...
      get_motor_measure(&MOTOR_PITCH, rx_data);
      break;			
...
void PITCH_Transmit(int16_t pitch)
{
    uint32_t send_mail_box;
    ...
    HAL_CAN_AddTxMessage(&PITCH_CAN, &pitch_tx_message, pitch_can_send_data, &send_mail_box);
}
